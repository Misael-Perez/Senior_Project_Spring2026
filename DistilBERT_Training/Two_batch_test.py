...
training_args= TrainingArguments(
    output_dir="./Single_session_results_test", #Changed because it doesn't require a large number for a small portion
...
print("For reference, we have the amount of supports, refutes, and nei in the test")
print(supports_count)
print(refutes_count)
print(nei_count)
